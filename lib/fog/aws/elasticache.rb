    ...
    class Elasticache < Fog::Service
      ...
      class Mock
        ...
        def initialize(options={})
          ...
          unless %w(ap-northeast-1 ap-northeast-2 ap-northeast-3 ap-southeast-1 eu-west-1 eu-west-2 us-east-1 us-east-2 us-west-1 us-west-2
                    sa-east-1 ap-south-1 ca-central-1).include?(@region)
