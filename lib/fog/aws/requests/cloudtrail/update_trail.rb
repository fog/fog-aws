  ...
  module AWS
    class CloudTrail
      ...
      class Real
        ...
        def update_trail(name, s3_bucket_name, s3_key_prefix=nil, sns_topic_name=nil, include_global_service_events=nil, cloud_watch_logs_log_group_arn=nil, cloud_watch_logs_role_arn=nil)
          request({
              'Action' => 'UpdateTrail',
              'Name' => name,
